    ...
    try {
      ...
      if (error) {
        ...
        if (error.code === 'PGRST116') {
          setError(`Código QR no encontrado (ID: ${id})`);
        } else {
          throw error;
        }
      } else {
      ...
      setError(`Error al cargar la información (ID: ${id})`);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600">
              Buscando el código QR en la base de datos.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-bold text-gray-900">Error - QR no encontrado</h1>
              </div>
              <button
                onClick={() => navigate('/')}
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6 text-left">
              <p className="text-gray-600 mb-2">
                <strong>ID del QR:</strong> {id}
              </p>
              <p className="text-gray-600 text-sm">
                Este código QR puede haber sido eliminado, o el ID no es válido.
              </p>
            </div>
            <div className="space-y-3">
              ...
              <ul className="text-gray-600 text-sm space-y-1 text-left max-w-md mx-auto">
                <li>• El código QR fue eliminado de la base de datos</li>
                <li>• El ID del QR no es válido</li>
                <li>• El QR fue generado antes de las correcciones</li>
                <li>• Error en la generación del QR</li>
              </ul>
            </div>
